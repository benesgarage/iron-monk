...
def test_len_constraint_success():
...
def test_len_constraint_failure():
    constraint = Len(min_len=2, max_len=4)
...
def test_contains_constraint_success():
...
def test_contains_constraint_failure():
    constraint = Contains("apple")
...
def test_unique_constraint_success():
...
def test_unique_constraint_failure():
    with pytest.raises(ValueError):
...
def test_one_of_constraint_success():
...
def test_one_of_constraint_failure():
    constraint = OneOf(["active", "pending", "closed"])
...
def test_each_init_and_type_failure():
    with pytest.raises(ValueError):
        Each()
...
def test_each_constraint_success():
    team = Team(
...
def test_each_constraint_failure():
    team = Team(
